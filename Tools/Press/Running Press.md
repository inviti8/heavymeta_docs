...
<img src="../../_resources/run_press.png" alt="run_press.png" width="583" height="229" class="jop-noMdConv">
...
<img src="../../_resources/press_sample_select.png" alt="press_sample_select.png" width="560" height="168" class="jop-noMdConv">
...
<img src="../../_resources/press_debug.png" alt="press_debug.png" width="520" height="186" class="jop-noMdConv">

Choose **Debug > Launch Debug**, to render the markdown into a site on localhost.

<img src="../../_resources/press_debug_site.png" alt="press_debug_site.png" width="720" height="458" class="jop-noMdConv">
...
<img src="../../_resources/press_open.png" alt="press_open.png" width="293" height="248" class="jop-noMdConv">

Folders, are shown in the Press ui, they represent "Pages" for the static app.

<img src="../../_resources/press_folders.png" alt="press_folders.png" width="311" height="484" class="jop-noMdConv">

The folders("Pages"), can be expanded, showing the markdown files, they represent "Articles" for the static site.

<img src="../../_resources/press_right_click_menu.png" alt="press_right_click_menu.png" width="307" height="340" class="jop-noMdConv">
...
![press_set_article_data.png](../../_resources/press_set_article_data.png)
...
![press_set_page_columns.png](../../_resources/press_set_page_columns.png)

We set the Color property to Red for page_a1.md.

![press_get_started_article_data.png](../../_resources/press_get_started_article_data.png)
Then for page_a2.md, we change the Column to 2, and set the Name to "Features".

![press_set_article_column.png](../../_resources/press_set_article_column.png)

Rebuild the site, and refresh the debug site, observe the changes.

![press_getting_started.png](../../_resources/press_getting_started.png)
